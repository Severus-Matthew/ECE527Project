...
proc create_root_design { parentCell } {
  ...
  # Create instance: FPGA_Acc_0, and set properties
  set FPGA_Acc_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:FPGA_Acc:1.0 FPGA_Acc_0 ]
  ...
  connect_bd_intf_net -intf_net FPGA_Acc_0_m_axi_DATA_BUS [get_bd_intf_pins FPGA_Acc_0/m_axi_DATA_BUS] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net FPGA_Acc_0_m_axi_DATA_BUS1 [get_bd_intf_pins FPGA_Acc_0/m_axi_DATA_BUS1] [get_bd_intf_pins axi_smc_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins FPGA_Acc_0/s_axi_CTRL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net FPGA_Acc_0_interrupt [get_bd_pins FPGA_Acc_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins FPGA_Acc_0/ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins FPGA_Acc_0/ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
