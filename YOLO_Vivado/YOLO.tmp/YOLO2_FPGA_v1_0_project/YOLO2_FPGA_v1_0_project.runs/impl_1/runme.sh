...
HD_PWD='/home/csl-403/Downloads/YOLO/YOLO.tmp/YOLO2_FPGA_v1_0_project/YOLO2_FPGA_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log YOLO2_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source YOLO2_FPGA.tcl -notrace
