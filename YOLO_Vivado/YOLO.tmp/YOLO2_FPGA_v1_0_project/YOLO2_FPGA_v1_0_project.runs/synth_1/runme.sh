...
HD_PWD='/home/csl-403/Downloads/YOLO/YOLO.tmp/YOLO2_FPGA_v1_0_project/YOLO2_FPGA_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log YOLO2_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source YOLO2_FPGA.tcl
