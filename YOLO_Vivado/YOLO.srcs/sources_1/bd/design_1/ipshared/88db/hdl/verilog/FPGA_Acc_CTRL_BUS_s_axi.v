...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    output wire [31:0]                   ifm,
    output wire [31:0]                   ofm,
...
localparam
    ...
    ADDR_IFM_CTRL             = 8'h14,
    ADDR_OFM_DATA_0           = 8'h18,
    ADDR_OFM_CTRL             = 8'h1c,
    ADDR_WEIGHT_DATA_0        = 8'h20,
    ADDR_WEIGHT_CTRL          = 8'h24,
    ADDR_BIAS_DATA_0          = 8'h28,
    ADDR_BIAS_CTRL            = 8'h2c,
    ADDR_K_S_PAD_LTYPE_DATA_0 = 8'h30,
    ADDR_K_S_PAD_LTYPE_CTRL   = 8'h34,
    ADDR_IOFM_NUM_DATA_0      = 8'h38,
    ADDR_IOFM_NUM_CTRL        = 8'h3c,
    ADDR_IFM_W_H_DATA_0       = 8'h40,
    ADDR_IFM_W_H_CTRL         = 8'h44,
    ADDR_OFM_W_H_DATA_0       = 8'h48,
    ADDR_OFM_W_H_CTRL         = 8'h4c,
    ADDR_TRTC_DATA_0          = 8'h50,
    ADDR_TRTC_CTRL            = 8'h54,
    ADDR_TMTN_DATA_0          = 8'h58,
    ADDR_TMTN_CTRL            = 8'h5c,
    ADDR_OFM_NUM_BOUND_DATA_0 = 8'h60,
    ADDR_OFM_NUM_BOUND_CTRL   = 8'h64,
    ADDR_MLOOPSXTM_DATA_0     = 8'h68,
    ADDR_MLOOPSXTM_CTRL       = 8'h6c,
    ADDR_MLOOPS_A1XTM_DATA_0  = 8'h70,
    ADDR_MLOOPS_A1XTM_CTRL    = 8'h74,
    ADDR_PAD_VAL_DATA_0       = 8'h78,
    ADDR_PAD_VAL_CTRL         = 8'h7c,
    ADDR_TROWTCOL_DATA_0      = 8'h80,
    ADDR_TROWTCOL_CTRL        = 8'h84,
    ADDR_IHW_DATA_0           = 8'h88,
    ADDR_IHW_CTRL             = 8'h8c,
    ADDR_OHW_DATA_0           = 8'h90,
    ADDR_OHW_CTRL             = 8'h94,
    ADDR_KK_INUMXKK_DATA_0    = 8'h98,
    ADDR_KK_INUMXKK_CTRL      = 8'h9c,
    ADDR_EN_BITS_DATA_0       = 8'ha0,
    ADDR_EN_BITS_CTRL         = 8'ha4,
    ADDR_WEIGHTQ_DATA_0       = 8'ha8,
    ADDR_WEIGHTQ_CTRL         = 8'hac,
    ADDR_BETAQ_DATA_0         = 8'hb0,
    ADDR_BETAQ_CTRL           = 8'hb4,
    ADDR_INPUTQ_DATA_0        = 8'hb8,
    ADDR_INPUTQ_CTRL          = 8'hbc,
    ADDR_OUTPUTQ_DATA_0       = 8'hc0,
    ADDR_OUTPUTQ_CTRL         = 8'hc4,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
